    ...
    public partial class Pmv : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                FileStream pmv = new FileStream(@"F:\Прога\Проект 2\PMV.txt", FileMode.Open);
                pmv.Close();
                StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\PMV.txt");
                textBox1.Text = s[0];
                reader.Close();
        ...
        string[] s = File.ReadAllLines(@"F:\Прога\Проект 2\PMV.txt");
        int sch;
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (sch >= 90)
            {
                ...
                textBox1.Text = s[3];
                reader.Close();
                pictureBox2.ImageLocation = @"F:\Прога\Проект 2\bin\Debug\1.jpg";
            }
            if (sch >= 150)
            {
                StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\PMV.txt");
            ...
            if (sch >= 210)
            {
                ...
                textBox1.Text = s[5];
                reader.Close();
                pictureBox2.ImageLocation = @"F:\Прога\Проект 2\bin\Debug\2.jpg";
            }
            if (sch >= 270)
            {
                StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\PMV.txt");
            ...
            if (sch >= 330)
            {
                ...
                textBox1.Text = s[7];
                reader.Close();
                pictureBox2.ImageLocation = @"F:\Прога\Проект 2\bin\Debug\3.jpg";
            }
            if (sch >= 390)
            {
                StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\PMV.txt");

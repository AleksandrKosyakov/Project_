...
namespace Проект_2
{
    public partial class Load : Form
    {
        ...
        public Load()
        {
            InitializeComponent();
            LoadFont();
            //Присваивание шрифта элементам
            label1.Font = myFont1;
            //Запуск таймра, по истечению которого форма закрывается и открывается главное меню
            timer1.Start();
            text();
        }
        ...
        private void text()
        {
            //Метод, в котором выбирается случайная цитата при загрузке формы
        ...
        //Переменные, созданные для продвижения прогресс бара
        int a;
        int i;
        int b;
        private void timer1_Tick(object sender, EventArgs e)
        {
            //Код отвечающий за прогресс бар

...
namespace Проект_2
{
    public partial class tvV : Form
    {
        ...
        public tvV()
        {
            ...
            if (btn_nc.Enabled==false)
                MessageBox.Show("Для просмотра Второй Мировой войны требуется просмотреть Первую Мировую войну и Восхождение Гитлера к власти", "Объявление", MessageBoxButtons.OK, MessageBoxIcon.Warning);

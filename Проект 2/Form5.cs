...
namespace Проект_2
{
    public partial class Vmv : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (sch >= 100)
            {
                StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\VMV.txt");
                textBox1.Text = s[2];
                reader.Close();
            }
            if (sch >= 200)
        ...
        string[] s = File.ReadAllLines(@"F:\Прога\Проект 2\VMV.txt");
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                FileStream pmv = new FileStream(@"F:\Прога\Проект 2\VMV.txt", FileMode.Open);
                pmv.Close();
                StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\VMV.txt");
                textBox1.Text = s[0];
                reader.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            FileStream pmv = new FileStream(@"C:\Project-master\VMV.txt", FileMode.Open);
            pmv.Close();
            StreamReader reader = new StreamReader(@"F:\Прога\Проект 2\VMV.txt");
            textBox1.Text = s[1];
            reader.Close();

    ...
    public partial class Vmv : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (sch >= 100)
            {
                ...
                textBox1.Text = s[2];
                pictureBox2.ImageLocation = @"VMV-2.jpg";
                reader.Close();
            }
            if (sch >= 200)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[3];
                pictureBox2.ImageLocation = @"VMV-2-3.jpg";
                reader.Close();
            }
            if (sch >= 300)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[4];
                pictureBox2.ImageLocation = @"Barbar.jpeg";
                reader.Close();
            }
            if (sch >= 400)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[5];
                pictureBox2.ImageLocation = @"VMV-3.jpg";
                reader.Close();
            }
            if (sch >= 500)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[6];
                pictureBox2.ImageLocation = @"Britan.png";
                reader.Close();
            }
            if (sch >= 600)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[7];
                pictureBox2.ImageLocation = @"st.jpg";
                reader.Close();
            }
            if (sch >= 700)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[8];
                pictureBox2.ImageLocation = @"Hol.jpeg";
                reader.Close();
            }
            if (sch >= 800)
            {
            ...
            if (sch >= 1200)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[13];
                pictureBox2.ImageLocation = @"It.jpg";
                reader.Close();
            }
            if (sch >= 1300)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[14];
                pictureBox2.ImageLocation = @"D.jpg";
                reader.Close();
            }
            if (sch >= 1400)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[15];
                pictureBox2.ImageLocation = @"1945.jpg";
                reader.Close();
            }
            if (sch >= 1500)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[16];
                pictureBox2.ImageLocation = @"Pobeda.jpg";
                reader.Close();
            }
            if (sch >= 1600)
            {
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[17];
                pictureBox2.ImageLocation = @"Nagas.jpg";
                reader.Close();
            }
            ...
            if (year == 1945 && month == 9 && day == 2)
            {
                ...
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[18];
                pictureBox2.ImageLocation = @"Pobeda-2.png";
                reader.Close();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                StreamReader reader = new StreamReader(@"VMV.txt");
                textBox1.Text = s[1];
                pictureBox2.ImageLocation = @"VMV-1.jpg";
                reader.Close();
                timer++;
            }
